...
(function (factory) {
  ...
  $.dateRangePickerLanguages = {
      ...
      "cn": //simplified chinese
          ...
          "zh-Hant": // 繁体
          {
              ...
              "week-7": "日",
              "week-number": "周",
              "month-name": ["壹月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十壹月", "十二月"],
              "shortcuts": "快捷選擇",
              "past": "過去",
              "following": "將來",
              "previous": "&nbsp;&nbsp;&nbsp;",
              ...
              "default-single": "請選擇壹個日期",
              "default-default": "請選擇壹個日期範圍",
              "time": "時間",
              "hour": "小時",
              "minute": "分鐘"
        },
  ...
  $.fn.dateRangePicker = function (opt) {
      ...
      function dayClicked(day) {
          ...
          clearHovering();
          if(typeof(report) != "undefined"&&report == 'form21'){
            if(!opt.end && ($('.dataTab .active')[0].innerText=='自定义'||$('.dataTab .active')[0].innerText=='Customize')){
                // 墙效报表
                var start_date = new Date(opt.start), end_date = new Date(opt.start);
                start_date.setDate(start_date.getDate() - 29);
                end_date.setDate(end_date.getDate() + 29);
                var start_month = start_date.getMonth()+1;
                var end_month = end_date.getMonth()+1;
                if(String(start_month).length == 1){
                    start_month = '0' + start_month;
                }
                if(String(end_month).length == 1){
                    end_month = '0' + end_month;
                }
                var _start_date,_end_date
                if(start_date.getDate()<10){
                    _start_date = '0' + start_date.getDate();
                }else{
                    _start_date = start_date.getDate();
                }
                if(end_date.getDate()<10){
                    _end_date = '0' + end_date.getDate();
                }else{
                    _end_date = end_date.getDate();
                }
                var start_date = start_date.getFullYear()  + '-' + start_month  + '-' + _start_date,
                    end_date = end_date.getFullYear() + '-' + end_month  + '-' + _end_date;
                console.log(start_date,end_date);
                opt.startDate = new Date(start_date);
                opt.endDate = new Date(end_date);
            }else{
                opt.startDate = '';
                opt.endDate = '';
            }
      ...
      function checkSelectionValid() {
          ...
          if (opt.batchMode) {
              if (opt.start && opt.startDate && compare_day(opt.start, opt.startDate) < 0) {
                  opt.start = opt.startDate;
              }
              if (opt.end && opt.endDate && compare_day(opt.end, opt.endDate) > 0) {
                  opt.end = opt.endDate;
              }
      ...
      function showSelectedInfo(forceValid, silent) {
          ...
          if (opt.start) {
            if(opt.start instanceof Date){
              box.find('.start-day').html(getDateString(new Date(opt.start)));
            }else{
          ...
          if (opt.end) {
              if(opt.end instanceof Date){
                  box.find('.end-day').html(getDateString(new Date(opt.end)));
              }else{
      ...
      function generateMonthElement(date, month) {
          ...
          if (!opt.monthSelect ||
              ...
              return '<span class="month-element">' + nameMonth(date.get('month')) + '</span>';
          }
      ...
      function generateYearElement(date, month) {
          ...
          if (!opt.yearSelect ||
              ...
              return '<span class="month-element">' + fullYear + '</span>';
          }
