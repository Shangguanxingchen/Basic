...
var EditorChart = React.createClass({
  ...
  componentDidMount(){
    this.chart = echarts.init(this.refs.editor_product4, 'dark');
    this.refreshChart();
  },
  componentDidUpdate(){
    this.refreshChart();
  ...
  renderChart(){
    ...
    var myChart;
    if(typeof myCharts['editor_product4'] == 'undefined'){
      myChart = echarts.init(document.getElementById('editor_product4'))
      myCharts.editor_product4 = myChart
    }else{
      myChart = myCharts['editor_product4']
    }
    // var myChart = echarts.init(document.getElementById('editor_product4'));
    var names = [],amount;
  ...
  refreshChart(){
    ...
    // var value = this.props.series;
		...
		return(
      <div ref = "editor_product4" id = "editor_product4"></div>     
		)
	}
})
