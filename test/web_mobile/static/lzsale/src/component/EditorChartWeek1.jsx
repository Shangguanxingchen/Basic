...
var EditorChart = React.createClass({
  ...
  componentDidMount(){
    this.chart = echarts.init(this.refs.editor_product1, 'dark');
    this.refreshChart();
  },
  componentDidUpdate(){
    this.refreshChart();
  ...
  renderChart(){
    ...
    var myChart;
    if(typeof myCharts['editor_product1'] == 'undefined'){
      myChart = echarts.init(document.getElementById('editor_product1'))
      myCharts.editor_product1 = myChart
    }else{
      myChart = myCharts['editor_product1']
    }
    // var myChart = echarts.init(document.getElementById('editor_product1'));
    var names = [],amount;
  ...
  refreshChart(){
    ...
    // var value = this.props.series;
		...
		return(
      <div ref = "editor_product1" id = "editor_product1"></div>     
		)
	}
})
