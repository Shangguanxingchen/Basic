...
var MemberChart1 = React.createClass({
  ...
  componentDidMount(){
    this.chart = echarts.init(this.refs.member4, 'dark');
    this.refreshChart();
  },
  componentDidUpdate(){
    this.refreshChart();
  ...
  renderChart(){
    ...
    var myChart;
    if(typeof myCharts['member4'] == 'undefined'){
      myChart = echarts.init(document.getElementById('member4'))
      myCharts.member4 = myChart
    }else{
      myChart = myCharts['member4']
    }
    // var myChart = echarts.init(document.getElementById('member4'));
  ...
  render(){
    return(
      <div ref = "member4" id = "member4"></div>  
    )
  }
})
