...
import SaleStore from '../stores/SaleStore11.jsx';
var timeOut;
var Sale = React.createClass({
  ...
  onStatusChange(data){
    ...
    if(one == '1' && two == '1' && three == '1' && five == '1' && six == '1' && seven == '1' && eight == '1'){
    ...
    if(sale_day){
      ...
      this.setState({
        new_saleIn:{
          ...
          male_amount:sale_day.male_amount,
          female_amount:sale_day.female_amount
        }
      })
      flag = true;
    }else if(sale_week){
      ...
      this.setState({
        new_saleIn:{
          ...
          male_amount:sale_week.male_amount,
          female_amount:sale_week.female_amount
        }
      })
      flag = true;
    }else if(sale_month){
      ...
      this.setState({
        new_saleIn:{
          ...
          male_amount:sale_month.male_amount,
          female_amount:sale_month.female_amount
        }
      })
      flag = true;
    }
    ...
    if(sale_day_rate){
      ...
      this.setState({
        new_bagrate:{
          ...
          male_sale_count:sale_week_rate.male_sale_count,
          female_sale_count:sale_week_rate.female_sale_count,
        },
      })
      flag = true;
      ...
      this.setState({
        new_bagrate:{
          ...
          male_sale_count:sale_month_rate.male_sale_count,
          female_sale_count:sale_month_rate.female_sale_count,
        },
      })
      flag = true;
    }
  ...
  render(){
    ...
    // new_tong.tong_ratio = '-100.00%'
    // console.log('', new_tong.tong_ratio)
    // console.log((new_tong.tong_ratio + '').length > 6 ? '16px' : 'auto')
    return(
      <div className={this.state.loading ? 'loading position' :'hideloading position'}>
        <Row type = "flex" className = "content_1 BG">
          ...
          <Col span = {9} className="paddingLeft">
          ...
          <Col span = {15} className="col_two" style={{lineHeight:'40px'}}>
            <Col span = {8} ><span>{lang_obj[lang]['sale_order_short']}</span><span className="size_24">{new_ordercount.order_count}<b className="b_right">{lang!='en'?lang_obj[lang]['sheet']:''}</b></span></Col>
            <Col span = {8} ><span>{lang_obj[lang]['sale_quantity_short']}</span><span className="size_24">{new_bagrate.sale_count}<b className="b_right">{lang!='en'?lang_obj[lang]['piece']:''}</b></span></Col>
            <Col span = {8} ><span>{lang_obj[lang]['same_growth_rate']}</span><span className="size_24" style={{fontSize: ((new_tong.tong_ratio + '').length > 6 ? '16px' : '24px')}}>{new_tong.tong_ratio}</span></Col>
          </Col>

          <Col span = {14} style={{marginTop: '12px', marginBottom: '17px', fontSize: '14px'}}>
          ...
          <Col span = {10} className="sale_sexs_right">
            <Col span = {12}>
              <div className="sexs_men">
        ...
        <Row type = "flex" className = "content_1 content_2 BG">
          ...
          <span className="help" data-set="two" onClick={self.clickHelp}><img data-set="two" src="static/lzsale/src/img/help.png"/></span>
          </Col>
          <Col span = {10} className="tab">
