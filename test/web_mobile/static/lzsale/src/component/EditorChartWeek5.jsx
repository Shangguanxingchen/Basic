...
var EditorChart = React.createClass({
  ...
  componentDidMount(){
    this.chart = echarts.init(this.refs.editor_product5, 'dark');
    this.refreshChart();
  },
  componentDidUpdate(){
    this.refreshChart();
  ...
  renderChart(){
    ...
    var myChart;
    if(typeof myCharts['editor_product5'] == 'undefined'){
      myChart = echarts.init(document.getElementById('editor_product5'))
      myCharts.editor_product5 = myChart
    }else{
      myChart = myCharts['editor_product5']
    }
    // var myChart = echarts.init(document.getElementById('editor_product5'));
    var names = [],amount;
  ...
  refreshChart(){
    ...
    // var value = this.props.series;
		...
		return(
      <div ref = "editor_product5" id = "editor_product5"></div>     
		)
	}
})
