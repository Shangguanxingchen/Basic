...
var EditorChart = React.createClass({
  ...
  componentDidMount(){
    this.chart = echarts.init(this.refs.editor_product3, 'dark');
    this.refreshChart();
  },
  componentDidUpdate(){
    this.refreshChart();
  ...
  renderChart(){
    ...
    var myChart;
    if(typeof myCharts['editor_product3'] == 'undefined'){
      myChart = echarts.init(document.getElementById('editor_product3'))
      myCharts.editor_product3 = myChart
    }else{
      myChart = myCharts['editor_product3']
    }
    // var myChart = echarts.init(document.getElementById('editor_product3'));
    var names = [],amount;
  ...
  refreshChart(){
    ...
    // var value = this.props.series;
		...
		return(
      <div ref = "editor_product3" id = "editor_product3"></div>     
		)
	}
})
