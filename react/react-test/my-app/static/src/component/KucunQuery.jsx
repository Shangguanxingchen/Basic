...
module.exports = React.createClass({
    ...
    getInitialState(){
        ...
        return {
            ...
            search_product_code: false, //搜索产品是的弹窗状态值

            kind: '', //点击分类、品牌、店仓、系列时他们的关键字都会被存在这里,用于显示对应的弹窗内容
    ...
    render_columns(){
        ...
        for(var i in head_columns_key){
            ...
            if(head_columns_key[i] == 'product_code' || head_columns_key[i] == 'product_name' || head_columns_key[i] == 'order_created_at'){
