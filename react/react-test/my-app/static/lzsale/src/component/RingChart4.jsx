...
var RingChart = React.createClass({
  ...
  componentDidMount(){
    this.chart = echarts.init(this.refs.ring4, 'dark');
    this.refreshChart();
  },
  componentDidUpdate(){
    this.refreshChart();
  ...
  renderChart(){
    var option;
    var {lang} = this.state;
    var myChart = echarts.init(document.getElementById('ring4'));
    var value = this.props.series.sale_amount;
  	option = {
      tooltip : {
        trigger: 'item',
