...
var Day = React.createClass({
  ...
  onStatusChange(data){
    this.setState({
      ...
      M_month_indicator:data.M_month_indicator,
  ...
  handleChange(e){
    ...
    var {M_month_indicator} = this.state;
    console.log(222,M_month_indicator);
    ...
    return(
      <div>
        ...
        <Row type = "flex" className="nav_header">
          ...
          <Col span = {24}>
            <span style={{color:'#788195',fontFamily:'serif'}}>店员月指标设置</span>
          </Col>
        </Row>
        <Row type = "flex" className = "content_1 content_2 BG">
          ...
          <Col span = {16} className="right">
            <p style={{textAlign:'center',borderBottom:'1px solid #d5d5d5',padding:'14px 0'}}>月指标量 <span style={{fontSize:'20px'}}>{month.shop_month_indicator}</span>/<span style={{color:'red',fontSize:'20px'}}>未分配¥{indicator_unassigns}</span></p>
            <ul>
              <li>日期</li>
            ...
            <div className="btn">
              <ul>
                ...
                <a href ="#/indicator"><li onClick={this.handleClose}>取消</li></a>
              </ul>
            </div>
